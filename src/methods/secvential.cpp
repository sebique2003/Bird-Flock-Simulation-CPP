...
void secvential(vector<Boid>& boizi, int nr_iteratii) {
    ...
    for (int i = 0; i < nr_iteratii; ++i) {
        ...
        // pt fiecare boid in parte
        for (size_t i = 0; i < boizi.size(); ++i) {
            ...
            // COEZIUNE
            if (numar_coeziune > 0) {
                // Calculam centrul de masa al vecinilor
